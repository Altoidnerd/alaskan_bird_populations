...
def filter_by_keyword_csv(input_csv, *keywords, cols=['AttrDefinition'], verbose=False, outfile=None):
    ...
    filter_by_keyword_csv(plaintext csv::input_csv, list[str]::*keywords, list[str]::cols=['AttrDefinition'], verbose=False, outfile=None) -> plaintext csve
